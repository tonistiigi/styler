...
(function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (util.elementMatchesSelector(element, cssRule.selectorText)) {
          if ((_ref1 = sheet.media) != null ? _ref1.length : void 0) {
            media = Array.prototype.join.call(sheet.media, ' and ');
  ...
  getStyles = function(element) {
    var bestrule, el, els, explicitInherit, file, filteredStyles, index, length, media, name, nearEls, nearby, prop, property, result, rule, selector, styles, usedProperties, usedRules, value, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
    result = [];
    nearby = [];
    usedProperties = {};
    el = element;
    ...
    if (element) {
      ...
      for (index = _i = 0, _len = _ref.length; _i < _len; index = ++_i) {
        ...
        for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
          ...
          _ref4 = _getStyleData(rule.style, usedProperties, index);
          ...
          if (length > 0) {
            file = rule.parentStyleSheet.href || ((_ref5 = rule.parentStyleSheet.ownerNode) != null ? _ref5.getAttribute('data-url') : void 0);
      ...
      nearEls = (function() {
        ...
        _ref6 = [element.parentElement, element.previousElementSibling, element.nextElementSibling, element.firstChild];
        _results = [];
      ...
      _ref6 = util.getMatchedCSSRulesForElements(nearEls, '');
      for (index = _l = 0, _len3 = _ref6.length; _l < _len3; index = ++_l) {
        styles = _ref6[index];
  ...
  InspectorResult = (function() {
    ...
    InspectorResult.name = 'InspectorResult';
  ...
  startEmbedMode = function() {
    ...
    return embed.addEventListener('load', function() {
      var hasScript, script, scripturl, _len1, _m, _ref5;
      try {
