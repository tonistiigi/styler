...
(function() {
  ...
  define(function(require, exports, module) {
    ...
    FileItemView = Backbone.View.extend({
      ...
      openFile: function() {
        var _ref1;
        return app.console.openFile((_ref1 = this.model.get('file')) != null ? _ref1.get('url') : void 0);
      },
      onClick: function(e) {
        this.select();
        e.stopPropagation();
      ...
      render: function() {
        var depth, file, fromNow, items, mtime, name;
        items = this.model.get('items');
        ...
        if (file = this.model.get('file')) {
          ...
          if (fromNow >= 36e5 * 24 * 3) {
            this.$('.lastmod').text(moment(mtime).format('D/M/YYYY'));
          } else {
            this.$('.lastmod').text(moment(mtime).fromNow());
            this.renderDebounce();
          }
