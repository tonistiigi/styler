...
(function() {
  ...
  Console = (function() {
    ...
    Console.prototype.addClientToFile = function(file, clientId) {
      ...
      client = Clients.get(clientId);
      if ((_ref3 = client.published) == null) {
        client.published = {};
      }
      url = file.get('url');
  ...
  Console.getConsole = function(projectId) {
    var project, _base, _ref3;
    if (!(project = Projects.get(projectId))) {
      return null;
    }
    if ((_ref3 = (_base = Console.consoles)[projectId]) == null) {
    ...
    project.bind("remove", function() {
      ...
      if ((_ref4 = Console.consoles[projectId]) != null) {
        _ref4.destroy();
      }
