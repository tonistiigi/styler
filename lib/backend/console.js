...
(function() {
  ...
  Console = (function() {
    ...
    Console.prototype._scanDirectoryForFiles = function() {
      ...
      return _.each(files, function(_arg) {
        ...
        return fs.readdir(path, function(err, flist) {
          var file, fname, fpath, furl, _i, _len, _results;
          if (err) {
          ...
          for (_i = 0, _len = flist.length; _i < _len; _i++) {
            ...
            if (file) {
              ...
              _results.push(fs.stat(fpath, function(err, stat) {
    ...
    Console.prototype.listenFile = function(file) {
      ...
      this.files.trigger("updated", file);
    ...
    Console.prototype._onFileChange = function(f) {
      ...
      for (parent in _ref3) {
        ...
        if (_ref4 = f.srcpath, __indexOf.call(imports, _ref4) >= 0) {
          file = this.files.find(function(ff) {
            return ff.srcpath === parent;
          });
          if (file) {
            _results.push(this.publish(file));
          } else {
